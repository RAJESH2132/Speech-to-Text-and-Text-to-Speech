...
#gtts module helps in playing sound after converting text to speech
#intitializing main window
...
# Speak and recordvoice function
def say(text1):
     language = 'en'
...
def TextToSpeech():
    ...
    texttospeechwindow.title('Text-to-Speech Converter by Rajesh')
    texttospeechwindow.geometry("500x500")
    texttospeechwindow.configure(bg='Blue')
 
    Label(texttospeechwindow, text='Text-to-Speech Converter by Rajesh', font=("Times New Roman", 15), bg='Blue').place(x=50)
...
def SpeechToText():
    ...
    speechtotextwindow.title('Speech-to-Text Converter by Rajesh')
    speechtotextwindow.geometry("500x500")
    speechtotextwindow.configure(bg='pink')
 
    Label(speechtotextwindow, text='Speech-to-Text Converter by Rajesh', font=("Comic Sans MS", 15), bg='IndianRed').place(x=50)
...
Label(mainwindow, text='Rajesh Text-To-Speech and Speech-To-Text Converter',
